...
public class AStarGrid : MonoBehaviour
{
    ...
    void CreateGrid()
    {
        ...
        Vector3 worldBottonLeft = transform.position - Vector3.right * gridWorldSize.x / 2 - Vector3.up
            * gridWorldSize.y / 2;
        ...
        for (int x = 0; x < gridSizeX; x++)
        {
            ...
            {
                Vector3 worldPoint = worldBottonLeft + Vector3.right * (x * nodeDiameter + nodeRadius) + Vector3.up
